...
public class DefaultSyntaxKit extends DefaultEditorKit implements ViewFactory {
    ...
    public void addSyntaxActions(Keymap map, String prefix) {
        ...
        Enumeration enu = actionsConf.propertyNames();
        while (enu.hasMoreElements())
        {
        	String actionName = (String) enu.nextElement();
    ...
    public static void initKit() {
        ...
        CONFIG = new Configuration(JarServiceProvider.readProperties2("jsyntaxpane.config"));
        ...
        Properties kitsForTypes = JarServiceProvider.readProperties2("jsyntaxpane.kitsfortypes");
        
        Enumeration enu = kitsForTypes.propertyNames();
        while (enu.hasMoreElements())
        {
